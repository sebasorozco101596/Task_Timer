...
const val CONTENT_AUTHORITY = "www.sebasorozco.com.tasktimer.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher {
        ...
        // e.g. content: //www.sebasorozco.com.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)

        // e.g. content: //www.sebasorozco.com.tasktimer.provider/Tasks/8
    ...
    override fun query(
        ...
        when (match) {
            ...
            TASKS_ID -> {
                ...
                //The next line append the '   ' to all the code that will be write there
